...
public class MapsTracking extends FragmentActivity implements OnMapReadyCallback, ValueEventListener {
    ...
    private void registerEventRealtime() {
        ...
        trackingUserLocation = FirebaseDatabase.getInstance().getReference(Common.PUBLIC_LOCATION).child(Common.trackingUser.getUid());
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        if(dataSnapshot.getValue() != null)
        {
            ...
            mMap.addMarker(new MarkerOptions().position(userMarker).title(Common.trackingUser.getEmail())
                    .snippet(Common.getDateFormatted(Common.convertTimeStampToData(location.getTime()))));
